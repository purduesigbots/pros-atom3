      ...
      <div className="pros-welcome">
        <div className="container">
          ...
          <section className="panel">
            ...
            <ul>
              <li>
                <a onclick={shell.openExternal('https://pros.cs.purdue.edu/v5/getting-started/new-users.html')}>This Page</a> for a guide to getting started with PROS for Atom.
              </li>
              <li>The <a onclick={shell.openExternal('https://pros.cs.purdue.edu/v5/tutorials/index.html')}>PROS tutorial page</a> to learn about using everything from sensors to motors to tasks and multithreading in PROS.</li>
              <li>The <a onclick={shell.openExternal('https://pros.cs.purdue.edu/v5/api/index.html')}>PROS API documentation</a>.</li>
            </ul>
          ...
          <footer className="footer">
            ...
            {/*<a onclick={shell.openExternal('https://github.com/purduesigbots')}className="icon icon-octoface"></a>*/}
          </footer>
        </div>
      </div>
    )
