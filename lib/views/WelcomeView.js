    ...
    return (
      ...
      { fill: '#7E868C' }}/>
        ...
        <svg xmlns='http://www.w3.org/2000/svg' width='160' height='35' viewBox='0 0 160 35'>
          <path d='M29.9 12.6c0 7.8-4.9 12.4-13.4 12.4h-5.9v9.2H1.9V0.9h14.6C25 0.9 29.9 5.2 29.9 12.6zM21.6 12.8c0-3.3-2-5-5.5-5h-5.5v10.2h5.5C19.6 18 21.6 16.2 21.6 12.8z' style={
      { fill: '#ffffff' }}/>
          <path d='M62.5 34.1l-4.8-9.2h-0.2 -6.3v9.2h-8.7V0.9h14.9c8.8 0 13.8 4.3 13.8 11.7 0 5-2.1 8.7-5.9 10.7l6.9 10.8H62.5zM51.3 18h6.3c3.5 0 5.5-1.8 5.5-5.2 0-3.3-2-5-5.5-5h-6.3V18z' style={{fill: '#ffffff'}}/>
          <path d='M119.1 17.5c0 9.7-7.7 17-18 17 -10.3 0-17.9-7.3-17.9-17 0-9.7 7.7-16.8 18-16.8C111.4 0.7 119.1 7.9 119.1 17.5zM92.1 17.5c0 5.4 4.2 9.6 9.1 9.6 5 0 9-4.2 9-9.6s-4-9.5-9-9.5C96.3 8.1 92.1 12.1 92.1 17.5z' style={
      { fill: '#ffffff' }}/>
          <path d='M144 7.6c-2.1 0-3.5 0.8-3.5 2.3 0 5.5 17.5 2.4 17.5 14.3 0 6.8-6 10.2-13.4 10.2 -5.5 0-11.3-2-15.3-5.3l3.4-6.8c3.4 2.9 8.6 5 12 5 2.6 0 4.2-0.9 4.2-2.7 0-5.6-17.5-2.2-17.5-14 0-6.2 5.3-10.1 13.3-10.1 4.9 0 9.8 1.5 13.3 3.7l-3.3 6.9C151.2 9.1 146.8 7.6 144 7.6z' style={{fill: '#ffffff'}}/>
        </svg>
